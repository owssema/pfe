				...
				<div class="container" style="width:78%">
					<div class="row justify-content-between">
						<div style="display:flex;align-items:center">
								<h1 style="margin-right:50px">Modifier Un Produit</h1>
                        </div>	
                        <form style="width:60%;" action="modifier.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="des" class="form-label">Désignation</label>
                                <input value="<?php echo $prod["Desingation"];?>" required name="des" type="text" class="form-control" id="des" aria-describedby="emailHelp">
                                
                            </div>
                            <div class="mb-3">
                                
                                <input hidden value="<?php echo $prod["id"];?>" required name="id" type="text" class="form-control" id="des" aria-describedby="emailHelp">
                                
                            </div>
                            <div class="mb-3">
                                <label for="desc" class="form-label">Description</label>
                                <textarea  required name="desc"  type="text" class="form-control" id="desc"><?php echo $prod["Description"];?></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="prix" class="form-label">Prix</label>
                                <input value="<?php echo $prod["prix"];?>" required name="prix" type="text" class="form-control" id="prix" aria-describedby="emailHelp">
